...
public class actuatorTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "actuator";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final actuatorTypeSupport _singleton
    = new actuatorTypeSupport();
    ...
    */
    public static actuatorTypeSupport get_instance() {
        return _singleton;
    }

    public static actuatorTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return actuatorTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>actuator</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        actuator typedDst = (actuator) destination;
        actuator typedSrc = (actuator) source;
        ...
        Object sample) 
    {
        ...
        actuator typedSrc = (actuator) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.status);

            dst.writeInt(typedSrc.Uid);

            dst.writeInt(typedSrc.tempInput);

            dst.writeInt(typedSrc.buttonInput);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            actuator typedDst = (actuator) dst;
            typedDst.clear();      
            try{
                typedDst.status = src.readInt();
                typedDst.Uid = src.readInt();
                typedDst.tempInput = src.readInt();
                typedDst.buttonInput = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            actuator typedDst = (actuator) sample;
    ...
    int mask) {
        return new actuatorDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new actuatorDataReader(native_reader, listener, mask, this);   
    ...
    protected actuatorTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,actuatorTypeCode.VALUE,actuator.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected actuatorTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,actuatorTypeCode.VALUE,actuator.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
