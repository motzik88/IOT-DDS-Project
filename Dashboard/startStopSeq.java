...
/**
* A sequence of startStop instances.
*/
public final class startStopSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public startStopSeq() {
        super(startStop.class);
    }

    public startStopSeq (int initialMaximum) {
        super(startStop.class, initialMaximum);
    }

    public startStopSeq (Collection elements) {
        super(startStop.class, elements);
    }

    public  startStop get(int index) { 
        return (startStop) super.get(index); 
    }
