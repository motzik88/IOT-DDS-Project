...
public class startStopTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "startStop";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final startStopTypeSupport _singleton
    = new startStopTypeSupport();
    ...
    */
    public static startStopTypeSupport get_instance() {
        return _singleton;
    }

    public static startStopTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return startStopTypeCode.VALUE;
    }

    public Object create_data() {
        return startStop.create();
    }
    ...
    * <code>this</code> is not a <code>startStop</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        startStop typedDst = (startStop) destination;
        startStop typedSrc = (startStop) source;
        ...
        Object sample) 
    {
        ...
        startStop typedSrc = (startStop) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            startStop typedDst = (startStop) dst;
            typedDst.clear();      
            try{
                typedDst.button = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            startStop typedDst = (startStop) sample;
    ...
    int mask) {
        return new startStopDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new startStopDataReader(native_reader, listener, mask, this);   
    ...
    protected startStopTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,startStopTypeCode.VALUE,startStop.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected startStopTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,startStopTypeCode.VALUE,startStop.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
