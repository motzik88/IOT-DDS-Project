...
/**
* A sequence of tempSensor instances.
*/
public final class tempSensorSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public tempSensorSeq() {
        super(tempSensor.class);
    }

    public tempSensorSeq (int initialMaximum) {
        super(tempSensor.class, initialMaximum);
    }

    public tempSensorSeq (Collection elements) {
        super(tempSensor.class, elements);
    }

    public  tempSensor get(int index) { 
        return (tempSensor) super.get(index); 
    }
