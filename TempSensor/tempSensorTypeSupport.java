...
public class tempSensorTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "tempSensor";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final tempSensorTypeSupport _singleton
    = new tempSensorTypeSupport();
    ...
    */
    public static tempSensorTypeSupport get_instance() {
        return _singleton;
    }

    public static tempSensorTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return tempSensorTypeCode.VALUE;
    }

    public Object create_data() {
        return tempSensor.create();
    }
    ...
    * <code>this</code> is not a <code>tempSensor</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        tempSensor typedDst = (tempSensor) destination;
        tempSensor typedSrc = (tempSensor) source;
        ...
        Object sample) 
    {
        ...
        tempSensor typedSrc = (tempSensor) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            tempSensor typedDst = (tempSensor) dst;
            typedDst.clear();      
            try{
                typedDst.temp = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            tempSensor typedDst = (tempSensor) sample;
    ...
    int mask) {
        return new tempSensorDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new tempSensorDataReader(native_reader, listener, mask, this);   
    ...
    protected tempSensorTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,tempSensorTypeCode.VALUE,tempSensor.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected tempSensorTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,tempSensorTypeCode.VALUE,tempSensor.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
